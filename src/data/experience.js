...
export const experience = [
    {
        ...
        jobDescription: [ "Proficiency with full-stack development using the .NET framework and the WPF UI Framework.",
            "Heavily used JavScript, HTML, and CSS simultaneously with Scriban templating to create dynamic webpages.",
            "Collaborated in a Continuous Integration (CI) environment,utilising Bitbucket to automate build, test, and deployment pipelines, ensuring rapid and reliable software releases.",
            "Built applications in C# and C",
            "Helped develop software for real-time monitoring and control systems.",
    ...
    },
    {
        ...
        jobDescription: [ "Used C# to create software that would scrape data from documents and validate its accuracy.",
            "Developed highly tailored solutions for clients using our licensed software.",
            "Built excellent inter-personal skills as I had to regularly communicate with clients.",
            "Created highly tailored solutions using our licensed FileBound software.",
            "Made workflow solutions for clients that would make their document management much simpler.",
            "Would lead consultant lead projects that would require me to be involved in the development of their solution from start to finish.",
            "Used PowerShell to create scripts that would automate clients workflow for receiving and paying invoices. Saving our clients countless labour hours"
        ],
        image: consultant
    },
    {
